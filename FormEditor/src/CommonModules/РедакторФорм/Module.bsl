...
Функция НоваяКоманднаяПанель(КонтекстЭлемента, ИмяЭлемента, Заголовок = "") Экспорт
	...
	КонтекстЭлемента.Свойства.Вставить("Вид", ВидГруппыФормы.КоманднаяПанель);
	Возврат НоваяГруппаФормы(КонтекстЭлемента, ИмяЭлемента, Заголовок);
	
КонецФункции

// Добавляет подменю кнопок на форму, без заголовка
//
// Параметры:
//  КонтекстЭлемента - Структура - описание окружения создаваемого элемента и его свойств.
// 		* Форма - УправляемаяФорма - форма для которой выполняется действие.
...
Функция НоваяПодменюКнопок(КонтекстЭлемента, ИмяЭлемента, Заголовок = "") Экспорт
	...
	КонтекстЭлемента.Свойства.Вставить("Вид", ВидГруппыФормы.Подменю);
	Возврат НоваяГруппаФормы(КонтекстЭлемента, ИмяЭлемента, Заголовок);
...
// Параметры:
//  Форма - УправляемаяФорма - форма для которой выполняется действие.
//	ИмяРеквизита - Строка - Имя создааваемого реквизита формы.
//	Тип - Произвольный - .
//	Путь - Строка - 
//	Заголовок - Строка - Структура по которой заполняются свойства команды.
//	СохраняемыеДанные - Булево - 
//
//Пример:
//	РедакторФорм.НовыйРеквизитФормы(ЭтотОбъект, "ккВидДоговора", Тип("Строка"), ,НСтр("ru = 'Вид договора'"));
//
Процедура НовыйРеквизитФормы(Форма, ИмяРеквизита, Тип, Путь = "", Заголовок, СохраняемыеДанные = Ложь) Экспорт

	// Опишем ревизит формы
	НовыйРеквизит = Новый РеквизитФормы(ИмяРеквизита, Тип, Путь, Заголовок, СохраняемыеДанные);
